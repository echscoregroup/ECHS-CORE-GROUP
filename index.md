...
<BR><BR>
<img src="{{ "/assets/tipuesearch/Bangalore.jpg" | relative_url }}">! <img src="{{ "/assets/tipuesearch/star.jpg" | relative_url }}">![alttext](https://github.com/echscoregroup/images/blob/main/1aHE.gif?raw=true)<B>07 DEC 2021 – FOR BANGALORE – Manipal Hospital , an Empanelled Hospital used to provide facility for Veterans to pay ECHS rates and get Specialist Consultation directly under own arrangements on production of ECHS Card as Identity proof. This facility has been stopped since 2 days for reasons best known to them. Info. They continue to provide facilities as per Empanelled Hospital agreement for Referrals, etc</B>
<BR><BR>
