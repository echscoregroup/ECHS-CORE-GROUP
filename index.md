...
<BR><BR>
<img src="{{ "/assets/tipuesearch/India.jpg" | relative_url }}">![alttext](https://github.com/echscoregroup/images/blob/main/1aHE.gif?raw=true)<B>FOR ALL INDIA - 05 JUL 2021 – ? DID YOU KNOW ? – If you want to correct 64kB ECHS Card Application even after your Record Office has Verified it successfully, you can do this by using REVERT APPLICATION option. To know the procedure , click STEP BY STEP PROCEDURES link above , under ECHS CARD heading click the document PROCEDURE USE OF REVERT APPLICATION 64kB CARD</B>
<BR><BR>
