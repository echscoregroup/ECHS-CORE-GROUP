...
# Important Messages
<hr>
<p style="color:Maroon;"><img src="{{ "/assets/tipuesearch/Bangalore.jpg" | relative_url }}"><img src="{{ "/assets/tipuesearch/star.jpg" | relative_url }}">! <img src="{{ "/assets/tipuesearch/new.gif" | relative_url }}"><b>28  APR 2023 – ALL INDIA- MoD letter dated 21 Apr 2023 ABOUT Exit from ECHS Membership & conditions is available here for your reference . To read this click on POLICY LETTERS link above , under the heading MEMBERSHIP  click the letter MoD LETTER 21 APR 2023 POLICY FOR EXIT FROM ECHS</B>
</P>
