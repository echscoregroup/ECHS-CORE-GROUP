...
# Important Messages
<hr>
<p style="color:Maroon;"><img src="{{ "/assets/tipuesearch/Bangalore.jpg" | relative_url }}"><img src="{{ "/assets/tipuesearch/star.jpg" | relative_url }}">! <img src="{{ "/assets/tipuesearch/new.gif" | relative_url }}"><b> 453.	26 SEP 2023 – ALL INDIA – From Commander V K Santhanam , HELPING HANDS FOR ECHS – IMPORTANT POLICY ON TREATMENT AT NON EMPANELLED HOSPITAL.  The letter is available in this portal. To Read it, click on ECHS POLICY LETTERS link above. In the page that opens under EMPANELLED & NON EMPANELLED HOSPITALS heading click the letter TREATMENT AT NON EMPANELLED HOSPITAL CONDITIONS</B>    
</P>
