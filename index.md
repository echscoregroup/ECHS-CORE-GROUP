...
<BR><BR><img src="{{ "/assets/tipuesearch/India.jpg" | relative_url }}">![alttext](https://github.com/echscoregroup/images/blob/main/1aHE.gif?raw=true)<B>FOR ALL INDIA – 05 AUG 2021 – A STEP -BY-STEP Procedure for  Use of Empanelled Hospital facilities under Routine Referral has been updated today with important changes & is shared in this web portal. To read this Procedure – click STEP BY STEP PROCEDURES link above, under EMPANELLED HOSPITALS heading click PROCEDURE USE OF EMPANELLED HOSPITAL FACILITIES ROUTINE REFERRAL</B>
